...
def calculate_health_score(metrics: Dict, tracker_status: Dict, display_info: Dict) -> Dict[str, float]:
    ...
    try:
        ...
        is_headless = not display_info.get("connected", False) and len(display_info.get("displays", [])) == 0
        scores["display"] = 100 if display_info.get("connected", False) or is_headless else 0
