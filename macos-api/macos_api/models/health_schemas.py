"""
Local Health Data Schemas for macOS API

Self-contained Pydantic models for standardized health data.
This ensures the macos-api project can run independently without external dependencies.
"""
...
class MacOSCapabilities(BaseModel if PYDANTIC_AVAILABLE else object):
    """macOS-specific capabilities."""
    
    def __init__(self, supports_camera_stream: bool = True, supports_tracker_restart: bool = True,
                 supports_reboot: bool = True, supports_ssh: bool = True, device_has_camera_support: bool = True, **kwargs):
        if PYDANTIC_AVAILABLE:
            super().__init__(
                supports_camera_stream=supports_camera_stream,
                supports_tracker_restart=supports_tracker_restart,
            ...
            self.supports_camera_stream = supports_camera_stream
            self.supports_tracker_restart = supports_tracker_restart
    ...
    def dict(self):
        if PYDANTIC_AVAILABLE:
            ...
            return {
                "supports_camera_stream": self.supports_camera_stream,
                "supports_tracker_restart": self.supports_tracker_restart,
